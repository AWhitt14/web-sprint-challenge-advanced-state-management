...
import {addVillager, setError} from '../actions/index';
...
const stateToProps = state => {
  ...
  const dispatchToProps = {addVillager,setError}
  
  export default connect(stateToProps,dispatchToProps)(AddForm);
